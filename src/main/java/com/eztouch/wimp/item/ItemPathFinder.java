...
public class ItemPathFinder extends ItemWIMP
{
	...
	public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
	{
		if (!par2World.isRemote)
		{
			...
			EntityEnderEye entityPaperPlane = new EntityEnderEye(par2World, par3EntityPlayer.posX, par3EntityPlayer.posY + 1.62D - (double) par3EntityPlayer.yOffset, par3EntityPlayer.posZ);
			...
			EntityPathFinderTrail entityPathFinder = new EntityPathFinderTrail(par2World);

			entityPathFinder.setPositionAndRotation(par3EntityPlayer.posX, par3EntityPlayer.posY, par3EntityPlayer.posZ, 0, 0);
